...
Let us now investigate the effects the anisptropy has on the spectral function of a single hole in the~XXZ~model. 
...
\begin{figure}
	...
	\subfloat[$\alpha = 0.8$]{
		\includegraphics[width=0.45\textwidth]{../figures/fig013.png}
	}
	\\
	\subfloat[$\alpha = 0.7$]{
		\includegraphics[width=0.45\textwidth]{../figures/fig002.png}
	}
	\subfloat[$\alpha = 0.5$]{
		\includegraphics[width=0.45\textwidth]{../figures/fig005.png}
	}
